...
### протух или нет
sudo chage -l <имя_пользователя> текущие папраметры УЗ
sudo chage -E 2024-10-15 username- установить время истечение срока для УЗ
sudo chage -d 0 требование смены паролья

#### группы
getent group - список всех групп
groups developer - Посмотреть группы	
id
id username
getent passwd user_2 - инфомауци о юзере из passwd
😃️adduser name- добавитьи в режиме диалога
useradd new_group - добавить юзера без всего
getent passwd {1000..60000}
su admin - заменяет оболочку (bash) на указаную
#### Удалить из группы
sudo gpasswd -d username astra-admin

😃️sudo usermod admin -aG astra-admin -  добавть пользователя admin в группу astra-admin
#### добавить пароль
passwd admin
